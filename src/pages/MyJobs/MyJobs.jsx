                ...
                <tbody>
                  {data.map((post, i) => (
                    <tr key={i} className="cursor-pointer my-5">
                      ...
                      <td className="text-nowrap">{post.amount}</td>
                      <td className="text-nowrap">
                        {post.completed} / {post.quantity}
                        {/* 50/100 */}
                        {/* <ProgressBar now={60} label={`${60}%`} /> */}
                      </td>
                      <td className="text-nowrap">{getStatusLabel(post.status)}</td>
                      <td className="text-nowrap">{moment(post.updated_at).format("LLL")}</td>
                      <td className="text-nowrap">
                        <Button
